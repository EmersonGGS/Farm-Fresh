...
- (void)viewDidLoad
{
    ...
    menuItems = @[@"home", @"shoppinglist", @"markets", @"logout" ];
    [UIImage imageNamed:@"Logofarm-1.png"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //cell.contentView.backgroundColor = [UIColor colorWithRed:0.973 green:0.969 blue:0.894 alpha:1.0];
    return cell;
}
